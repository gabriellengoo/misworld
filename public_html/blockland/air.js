class Game{
	constructor(){
		...
		const options = {
			assets:[
				`${this.assetsPath}images/air/front.png`,
				`${this.assetsPath}images/air/back.png`,
				`${this.assetsPath}images/air/bottom.png`,
				`${this.assetsPath}images/air/top.png`,
				`${this.assetsPath}images/air/right.png`,
				`${this.assetsPath}images/air/left.png`
	...
	loadEnvironment(loader){
		...
		loader.load(`${this.assetsPath}fbx/town.fbx`, function(object){
			...
			tloader.setPath( `${game.assetsPath}/images/air/` );
