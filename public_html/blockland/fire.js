class Game{
	constructor(){
		...
		const options = {
			assets:[
				// `${this.assetsPath}images/fire/nx.jpg`,
				// `${this.assetsPath}images/fire/px.jpg`,
				// `${this.assetsPath}images/fire/ny.jpg`,
				// `${this.assetsPath}images/fire/py.jpg`,
				// `${this.assetsPath}images/fire/nz.jpg`,
				// `${this.assetsPath}images/fire/pz.jpg`
	...
	loadEnvironment(loader){
		...
		loader.load(`${this.assetsPath}fbx/town.fbx`, function(object){
			...
			tloader.setPath( `${game.assetsPath}/images/fire/` );
