class Game{
	constructor(){
		...
		const options = {
			assets:[
				`${this.assetsPath}images/water/front.jpg`,
				`${this.assetsPath}images/water/back.jpg`,
				`${this.assetsPath}images/water/bottom.jpg`,
				`${this.assetsPath}images/water/top.jpg`,
				`${this.assetsPath}images/water/right.jpg`,
				`${this.assetsPath}images/water/left.jpg`
	...
	loadEnvironment(loader){
		...
		loader.load(`${this.assetsPath}fbx/town.fbx`, function(object){
			...
			tloader.setPath( `${game.assetsPath}/images/water/` );
