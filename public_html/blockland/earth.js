class Game{
	constructor(){
		...
		const options = {
			assets:[
				`${this.assetsPath}images/earth/nx.jpg`,
				`${this.assetsPath}images/earth/px.jpg`,
				`${this.assetsPath}images/earth/ny.jpg`,
				`${this.assetsPath}images/earth/py.jpg`,
				`${this.assetsPath}images/earth/nz.jpg`,
				`${this.assetsPath}images/earth/pz.jpg`
	...
	loadEnvironment(loader){
		...
		loader.load(`${this.assetsPath}fbx/town.fbx`, function(object){
			...
			tloader.setPath( `${game.assetsPath}/images/earth/` );
